    ...
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-32 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        ...
        <div className='flex items-center mt-6 font-medium'>
          <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-dull transition rounded text-white cursor-pointer'>
            Shop Now
            <img className='md:hidden transition-transform group-focus:translate-x-1' src={assets.white_arrow_icon} alt="Arrow" />
          </Link>
