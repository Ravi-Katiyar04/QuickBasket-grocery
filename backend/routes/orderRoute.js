...
import { placedOrderCOD, getUserOrders , getAllOrders, placedOrderStripe} from '../controllers/orderController.js'; // Import the order controller functions
...
orderRouter.post('/stripe', authUser, placedOrderStripe); // For admin
